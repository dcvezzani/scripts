...
function! GetEmojiTranslation() range
  let @w = GetVisualSelection(visualmode())
  let @z = 'gvdk' | normal @z

  execute 'r! ~/scripts/cat-to-file.sh '.shellescape(@w, 1).' ~/scripts/get-emoji-translation.js'
endfunction

xnoremap qtt :<C-U> call GetEmojiTranslation()<Cr>
