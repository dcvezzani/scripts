...
Usage: 
~/scripts/pdf_rebuild_cross_reference_table.sh $HOME_DIR/Downloads/wip01/invoice-002.pdf
PDF_REBUILD_CROSS_REFERENCE_TABLE_NO_PROMPT=true ~/scripts/pdf_rebuild_cross_reference_table.sh $HOME_DIR/Downloads/wip01/invoice-002.pdf

Can handle from 1 to 10 pdf documents at a time.
~/scripts/pdf_rebuild_cross_reference_table.sh $HOME_DIR/Downloads/wip01/invoice-002.pdf <file> <file> ...
" 1>&2; exit 1
fi
