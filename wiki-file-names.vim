function! WikiFileName(...)
  ...
  let cleanWfn = split($WFN, '') + ['https://bitbucket.org/greenseedtech/storm/wiki/'.@y, 'https://bitbucket.org/greenseedtech/storm/wiki/edit/zonners-authored-documents', 'echo "Recent discovery', 'https://bitbucket.org/greenseedtech/storm/wiki/'.@y, '" | slackcat --channel storm_team --stream']
